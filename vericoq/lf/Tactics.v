...
Proof.
  ...
  - intros. destruct m.
    ...
    + simpl in H. rewrite <- plus_n_Sm in H. rewrite <- plus_n_Sm in H.
      injection H as H1. f_equal. apply IHn.
      apply H1.
Qed.
(** [] *)
...
Proof.
  ...
  - intros. simpl. destruct n.
    + discriminate H.
    + apply IHl. injection H as H. apply H.
Qed.
(** [] *)
...
Proof.
  induction l.
  - intros. simpl in H. injection H as H1 H2. rewrite <- H1. rewrite <- H2. reflexivity.
  - intros.
    destruct x.
    destruct l1.
    + simpl in H. destruct (split l). discriminate H.
    + destruct l2.
      simpl in H. destruct (split l). discriminate H.
      simpl in H. destruct (split l). injection H as H1 H2 H3.
      simpl. rewrite H1. rewrite H3. f_equal.
      apply IHl. rewrite H2. rewrite H. reflexivity.
Qed.
(** [] *)
